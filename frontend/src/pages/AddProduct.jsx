      ...
      <div className="min-h-screen bg-gradient-earth">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-display font-bold text-charcoal">Add New Product</h1>
            <p className="text-dark-gray mt-2">Create a new listing for your eco-friendly product</p>
          </div>
